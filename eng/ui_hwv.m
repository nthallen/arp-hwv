...
f = ne_dialg(f, 'add', 1, 0, 'phwvlaairvrf', 'RF' );
f = ne_dialg(f, 'add', 1, 0, 'phwvlaairvrfbw', 'dRFB Wdt' );
...
f = ne_dialg(f, 'add', 0, 1, 'ghwvhktm', 'T Mbase' );
f = ne_dialg(f, 'add', 1, 0, 'phwvhktmtd', 'T Drift' );
f = ne_dialg(f, 'add', 1, 0, 'phwvhktmcpu', 'CPU' );
f = ne_dialg(f, 'add', 1, 0, 'phwvhktmram', 'RAM' );
f = ne_dialg(f, 'add', 1, 0, 'phwvhktmd', 'Disk' );
f = ne_dialg(f, 'newcol');
...
f = ne_dialg(f, 'newcol');
f = ne_dialg(f, 'add', 0, 1, 'ghwvhhh', 'icosfitd' );
f = ne_dialg(f, 'add', 1, 0, 'phwvhhhscan', 'scan' );
f = ne_dialg(f, 'add', 1, 0, 'phwvhhhp', 'P' );
f = ne_dialg(f, 'add', 1, 0, 'phwvhhht', 'T' );
f = ne_dialg(f, 'add', 1, 0, 'phwvhhhnu_f0', 'nu F0' );
f = ne_dialg(f, 'add', 1, 0, 'phwvhhhppm', 'ppm' );
f = ne_dialg(f, 'add', 1, 0, 'phwvhhhfixflt', 'fixflt' );
f = ne_dialg(f, 'add', 1, 0, 'phwvhhhstatus', 'status' );
f = ne_dialg(f, 'newcol');
